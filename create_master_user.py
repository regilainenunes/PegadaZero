#!/usr/bin/env python3
"""
Script para criar o usuário master no banco de dados SQLite
"""
import sqlite3
import bcrypt
...
def hash_password(password: str) -> str:
    """Hash da senha usando bcrypt (compatível com o sistema)"""
    ...
    try:
        ...
        if existing_user:
            ...
            cursor.execute("""
                ...
                WHERE email = ?
            """, ("Master Admin", hashed_password, "Master", "master@pegadazero.local"))
            ...
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?, ?)
            """, ("Master Admin", "master@pegadazero.local", hashed_password, "Master", 0, datetime.utcnow()))
